...
@section('content')
    ...
    <div id="printableArea">
        ...
        <div class="row d-flex justify-content-between">
            <div class="col p-3">
                <h3 class="border-bottom text-info">Product Info:</h3>
        ...
        <div class="row d-flex justify-content-between">
            <div class="col p-3">
                <h3 class="border-bottom text-secondary">Workstation:</h3>
                ...
                @if ($menu_order->status != 'Delivered')
                    <p class="text-success"><b>Status :</b> {{ $menu_order->manufacturingWorkstation->status }}</p>
                @endif

            </div>
            <div class="col p-3">
                <h3 class="border-bottom text-warning">Assigned Worker</h3>
    ...
    <div class=" d-flex justify-content-between ">
        <a href="{{ route('pp.dashboard') }}" class="btn btn-lg btn-secondary">Go Back</a>
